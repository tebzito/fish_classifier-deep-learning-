...
hp.choice('num_layers',
    ...
    'conv1': hp.choice('conv1', [32, 64]),
    'conv2': hp.choice('conv2', [32, 64]),
    'conv3': hp.choice('conv3', [32, 64]),
    #'conv4': hp.choice('conv4', [32, 64]),
    ...
    #'nb_epochs' : 1,
    'nb_epochs' :  hp.choice('nb_epochs', [100,200,300]),
    #'optimizer': 'adam',
    #'activation': 'relu'
    'loss': hp.choice('loss', ['binary_crossentropy','categorical_crossentropy']),
    'optimizers': hp.choice('optimizers', ['adam','sgd','adadelta']),
    'activations': hp.choice('activations', ['relu','sigmoid']),
    'wr': hp.choice('wr', [0.01, 0.001, 0.0001, 0.00001])
